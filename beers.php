...
<link rel="stylesheet" type="text/css" href="css/beers.css?3889359957" id="pagesheet"/>
<!--[if lt IE 9]>
...
#totalBeerList tr:hover td
{
	color:#ffffff;
	background: #BE4040;
}
#totalBeerList tr:hover a { 
	color: #ffffff; 
}
...
<div class="position_content" id="page_position_content">
	...
	<div class="grpelem" id="u1542"><!-- custom html -->
		<table class="sortable" id="totalBeerList" summary="List of All Beers">
		<thead>
		<tr>
	...
	<?php
		$beerresult = mysql_query("")
			or die (mysql_error());
		while($beerrow = mysql_fetch_array($beerresult)){
				echo "<tr>
				<td width=\"30%\"><a href='breweryprofile.php?link=".$beerrow['BreweryID']."' class=\"beerTable\" style=\"display:block;\">". $beerrow['BreweryName'] ."</a></td>
				<td width=\"30%\"><a href='beerprofile.php?link=".$beerrow['BeerID']."' class=\"beerTable\" style=\"display:block;\">". $beerrow['BeerName'] ."</a></td>
				<td width=\"20%\">". $beerrow['Style'] ."</td>
				<td width=\"20%\">". $beerrow['count_trans'] ."</td>
				</tr>";
		}	
	?>
		</tbody>
