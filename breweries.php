...
<script type="text/javascript">
	if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["jquery-1.8.3.min.js", "museutils.js", "jquery.musemenu.js", "jquery.watch.js", "breweries.css"], "outOfDate":[]};
</script>
...
<link rel="stylesheet" type="text/css" href="css/breweries.css?4192889189" id="pagesheet"/>
<!--[if lt IE 9]>
<link rel="stylesheet" type="text/css" href="css/iefonts_breweries.css?4233922653"/>
<![endif]-->
<!-- Other scripts -->
<script type="text/javascript">
...
<body>
	...
	<div class="browser_width colelem" id="u2868-bw">
	<div id="u2868"><!-- group -->
	

	
	<div class="clearfix" id="u2868_align_to_page">
	
	<!-- BREWERY TABLE start ///////////////////////////// -->
	<div class="clearfix grpelem" id="u2869"><!-- group -->
	<div class="grpelem" id="u1735"><!-- custom html -->
        <table class="sortable" id="totalBreweryList" summary="List of All Brewerys">
		<thead>
		<tr>
		<th class="headspan" scope="col">Brewery Name:</th>
		<th class="headspan" scope="col">State:</th>
		<th class="headspan" scope="col">Country:</th>
		<th class="headspan" scope="col">Beer Count:</th>
		</tr>
		</thead>
		<tbody>
	<?php
		$breweryResult = mysql_query("")
			or die (mysql_error());
		while($brewrow = mysql_fetch_array($breweryResult)){
				echo "<tr>
				<td width=\"65%\"><a href='breweryprofile.php?link=".$brewrow['BreweryID']."' class=\"brewTable\"  style=\"display:block;\">". $brewrow['BreweryName'] ."</a></td>
				<td width=\"10%\">". $brewrow['State'] ."</td>
				<td width=\"10%\">". $brewrow['Country'] ."</td>
				<td width=\"15%\">". $brewrow['Beer_Count'] ."</td>
				</tr>";
		}	
	?>
		</tbody>
